...
class TestUploadToSpace:
    ...
    def test_upload_to_space_uses_upload_folder(self, mock_upload, staging_dir):
        """Test that upload_to_space uses upload_folder for bulk upload."""
        mock_upload.return_value = None
        
        upload_to_space("test_user/my-env", staging_dir, "test_token")
    ...
    @patch("openenv_cli.core.uploader.upload_folder")
    def test_upload_to_space_handles_errors(self, mock_upload, staging_dir):
    ...
    @patch("openenv_cli.core.uploader.upload_folder")
    def test_upload_to_space_empty_directory(self, mock_upload, tmp_path):
    ...
    @patch("openenv_cli.core.uploader.upload_folder")
    def test_upload_to_space_nested_files(self, mock_upload, staging_dir):
