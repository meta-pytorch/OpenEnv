...
from thinkingbox_env import SubmittedToolCall, ThinkingBoxEnv
from thinkingbox_env.client import DEFAULT_MESSAGE_TIMEOUT_S
...
from thinkingbox_env.server.data_loader import load_test_uids, resolve_data_bundle
...
class _ExecutionTrace:
    ...
    def capture_result(self, result: Any) -> None:
        ...
        elif self.execution_provenance is None:
            self.execution_provenance = dict(candidate)
        elif candidate != self.execution_provenance:
            self.execution_provenance_valid = False
