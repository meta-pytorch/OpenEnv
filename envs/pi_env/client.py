...
"""Client for the deployed pi_env server.

The server exposes a single MCP tool ``run_rollout`` that runs one Pi
        ...
        *,
        ...
        Args:
            ...
            image: Hugging Face sandbox image. Empty string uses the default
                (``python:3.12``, which cold-installs Node + Pi per rollout).
