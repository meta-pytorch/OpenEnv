...
"""ClaudeCodeSessionFactory.create() must tear the sandbox down on any post-provision failure."""
...
from claude_code_env.config import ClaudeCodeConfig  # noqa: E402
from claude_code_env.harness import ClaudeCodeSessionFactory  # noqa: E402
...
def _factory(sandbox, **overrides):
    return ClaudeCodeSessionFactory(
        config=ClaudeCodeConfig(base_url="http://localhost:8000/v1"),
