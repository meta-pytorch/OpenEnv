...
"""Pydantic models for the deployed claude_code_env HTTP server.
...
config, runs one Claude Code rollout end-to-end inside a Hugging Face sandbox, and
...
class ClaudeCodeState(State):
    """Per-session env state across calls to one ClaudeCodeEnvironment instance.
