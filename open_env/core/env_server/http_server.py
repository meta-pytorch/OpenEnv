...
class HTTPEnvServer:
    ...
    Example:
        >>> from open_env.core.env_server import HTTPEnvServer
        >>> from open_env.envs.coding_env.server import CodeExecutionEnvironment
        >>>
...
def create_fastapi_app(
    ...
    Example:
        >>> from open_env.envs.coding_env.server import CodeExecutionEnvironment
        >>> from open_env.envs.coding_env.models import CodeAction, CodeObservation
        >>>
        >>> env = CodeExecutionEnvironment()
