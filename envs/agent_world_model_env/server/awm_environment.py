...
from .scenario_manager import call_mcp_tool, list_mcp_tools, ScenarioProcess
...
class AWMEnvironment(Environment):
    ...
    def reset(
        ...
        **kwargs: Any,
        ...
        try:
            tools = _run_async(list_mcp_tools(mcp_url))
    ...
    def _handle_list_tools(self) -> AWMListToolsObservation:
        ...
        try:
            raw_tools = _run_async(list_mcp_tools(self._process.mcp_url))
    ...
    def _handle_verify(self, action: CallToolAction) -> AWMObservation:
        ...
        if verifier_mode == "sql" and reward_type != "judge_error":
            ...
            try:
                reward_type, judge_result = _run_async(
                    run_llm_judge(
                        task=self._task,
    ...
    def _handle_done(self, action: CallToolAction) -> AWMObservation:
        ...
        if self._session_dir and self._trajectory:
            trajectory_path = f"{self._session_dir}/trajectory.json"
            try:
