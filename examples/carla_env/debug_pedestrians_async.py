#!/usr/bin/env python3
"""
Debug script to check pedestrian spawn locations (async version).
"""
import sys
import base64
import asyncio
...
async def debug_pedestrian_spawn(base_url: str, scenario_name: str):
    ...
    async with env:
        ...
        result = await env.step(CarlaAction(action_type="capture_image"))
        obs = result.observation
...
if __name__ == "__main__":
    ...
    asyncio.run(debug_pedestrian_spawn(args.base_url, args.scenario))
